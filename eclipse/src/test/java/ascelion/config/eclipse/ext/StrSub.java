...
public class StrSub
{
	...
	{
		return new StrSub( valueMap ).replace( source );
	}
	...
	public static <V> String replace( final Object source,
			...
			final String suffix )
	{
		return new StrSub( valueMap, prefix, suffix ).replace( source );
	}
	...
	public static String replace( final Object source, final Properties valueProperties )
	{
		...
		return StrSub.replace( source, valueMap );
	}
	...
	{
		return new StrSub( StrLookup.systemPropertiesLookup() ).replace( source );
	}
	 ...
	 */
	public <V> StrSub( final Map<String, V> valueMap )
	{
	 ...
	 * @throws IllegalArgumentException if the prefix or suffix is null
	 */
	public <V> StrSub( final Map<String, V> valueMap, final String prefix, final String suffix )
	{
	 ...
	 */
	public StrSub( final StrLookup<?> variableResolver )
	{
	 ...
	 * @throws IllegalArgumentException if the prefix or suffix is null
	 */
	public StrSub( final StrLookup<?> variableResolver, final String prefix, final String suffix,
			final char escape )
	{
						...
						if( endMatchLen == 0 ) {
							...
							if( nestedVarCount == 0 ) {
								...
								if( varValue != null ) {
									...
									bufEnd += change;
									lengthChange += change;
									chars = buf.toCharArray(); // in case buffer was
									// altered
								}
	 ...
	 */
	public StrSub setVariablePrefixMatcher( final StrMatcher prefixMatcher )
	{
	 ...
	 * @return this, to enable chaining
	 */
	public StrSub setVariablePrefix( final char prefix )
	{
	 ...
	 */
	public StrSub setVariablePrefix( final String prefix )
	{
	 ...
	 */
	public StrSub setVariableSuffixMatcher( final StrMatcher suffixMatcher )
	{
	 ...
	 * @return this, to enable chaining
	 */
	public StrSub setVariableSuffix( final char suffix )
	{
	 ...
	 */
	public StrSub setVariableSuffix( final String suffix )
	{
	 ...
	 * @return this, to enable chaining
	 */
	public StrSub setValueDelimiterMatcher( final StrMatcher valueDelimiterMatcher )
	{
	 ...
	 * @return this, to enable chaining
	 */
	public StrSub setValueDelimiter( final char valueDelimiter )
	{
	 ...
	 * @return this, to enable chaining
	 */
	public StrSub setValueDelimiter( final String valueDelimiter )
	{
	 ...
	 * StrSub sub = new StrSub(valuesMap);
