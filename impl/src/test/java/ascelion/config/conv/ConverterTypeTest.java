...
public class ConverterTypeTest
{
	...
	static public Object data()
	{
		return new Object[] {
			...
			asArray( arrayOf( Integer.class ), asArray( ArrayConverter.class, lambda() ) ),
			asArray( arrayOf( Long.class ), asArray( ArrayConverter.class, lambda() ) ),
			asArray( arrayOf( Double.class ), asArray( ArrayConverter.class, lambda() ) ),

			asArray( parameterizedClass( List.class, String.class ), asArray( ListConverter.class, lambda() ) ),
			asArray( parameterizedClass( List.class, Integer.class ), asArray( ListConverter.class, lambda() ) ),
			asArray( parameterizedClass( List.class, Long.class ), asArray( ListConverter.class, lambda() ) ),
			asArray( parameterizedClass( List.class, URL.class ), asArray( ListConverter.class, lambda() ) ),

			asArray( parameterizedClass( Set.class, String.class ), asArray( SetConverter.class, lambda() ) ),
			asArray( parameterizedClass( Set.class, Integer.class ), asArray( SetConverter.class, lambda() ) ),
			asArray( parameterizedClass( Set.class, Long.class ), asArray( SetConverter.class, lambda() ) ),
			asArray( parameterizedClass( Set.class, URL.class ), asArray( SetConverter.class, lambda() ) ),

			asArray( parameterizedClass( Map.class, String.class, String.class ), asArray( MapConverter.class, lambda() ) ),
			asArray( parameterizedClass( Map.class, String.class, Integer.class ), asArray( MapConverter.class, lambda() ) ),
			asArray( parameterizedClass( Map.class, String.class, Long.class ), asArray( MapConverter.class, lambda() ) ),
			asArray( parameterizedClass( Map.class, String.class, URL.class ), asArray( MapConverter.class, lambda() ) ),
