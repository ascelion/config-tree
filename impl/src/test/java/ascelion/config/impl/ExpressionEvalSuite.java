...
public class ExpressionEvalSuite
{
	...
	static public Object data() throws IOException
	{
		...
		try( InputStream is = cld.getResourceAsStream( ExpressionEvalSuite.class.getSimpleName() + ".yml" ) ) {
	...
	public ExpressionEvalSuite( String unused, Map<String, Object> td ) throws ClassNotFoundException
	{
